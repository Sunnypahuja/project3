	...
	handleFormSubmit( event ) {
		...
		.then(function (response) {
			...
			{	
				...
				window.sessionStorage.setItem(window.btoa("session_admin"), window.btoa(email));
				window.sessionStorage.setItem(window.btoa("id"), window.btoa(response.data.replace('ok','')));
